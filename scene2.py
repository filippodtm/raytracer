...
#floor.material.pattern = Stripepattern(black(), mycolor.Color(1,0,0))
...
backdrop.material.pattern = Stripepattern(black(), Color(1,1,1))


middle = sphere()
middle.material.pattern = Stripepattern(Color(0,0,1), white())
